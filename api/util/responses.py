...
from api.util.base_serializer import get_error_message
...
class APIResponse:
    class Codes:
        ...
        # Certification codes
        CERTIFICATION_RETRIEVED = "CERTIFICATION_RETRIEVED"
        CERTIFICATION_CREATED = "CERTIFICATION_CREATED"
        CERTIFICATION_UPDATED = "CERTIFICATION_UPDATED"
        
        # Education codes
        EDUCATION_RETRIEVED = "EDUCATION_RETRIEVED"
        EDUCATION_CREATED = "EDUCATION_CREATED"
        EDUCATION_UPDATED = "EDUCATION_UPDATED"
        
        # Contact codes
        CONTACT_RETRIEVED = "CONTACT_RETRIEVED"
        CONTACT_CREATED = "CONTACT_CREATED"
        CONTACT_UPDATED = "CONTACT_UPDATED"

        # ContactInfo codes
        CONTACTINFO_RETRIEVED = "CONTACTINFO_RETRIEVED"
        CONTACTINFO_CREATED = "CONTACTINFO_CREATED"
        CONTACTINFO_UPDATED = "CONTACTINFO_UPDATED"
        ...
        _success_messages = {
            ...
            # Skill messages
            SKILL_RETRIEVED: "Skills retrieved successfully.",
            ...
            CERTIFICATION_RETRIEVED: "Certifications retrieved successfully.",
            CERTIFICATION_CREATED: "Certification created successfully.",
            CERTIFICATION_UPDATED: "Certification updated successfully.",
            
            # Education messages
            EDUCATION_RETRIEVED: "Education retrieved successfully.",
            EDUCATION_CREATED: "Education created successfully.",
            EDUCATION_UPDATED: "Education updated successfully.",
            
            # Contact messages
            CONTACT_RETRIEVED: "Contact messages retrieved successfully.",
            CONTACT_CREATED: "Contact message sent successfully.",
